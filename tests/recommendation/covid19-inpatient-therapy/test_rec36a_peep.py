...
@pytest.mark.recommendation
class TestRecommendation36aPeep2(TestRecommendationBaseV2):
    recommendation_url = (
        "covid19-inpatient-therapy/recommendation/covid19-ventilation-plan-peep"
    )
    recommendation_package_version = "latest"
    ...
    combinations = [
        ...
        # COVID19() | Ventilated() | FiO2_40() | PEEP_5() | PEEP_8() | PEEP_18(),
        ...
        # (COVID19() | Ventilated()) & FiO2_30() & FiO2_40() & ( PEEP_5() | PEEP_8() | PEEP_18()),
        ...
        # (COVID19() | Ventilated()) & FiO2_30() & FiO2_40() & FiO2_50() & FiO2_60() & (PEEP_5() | PEEP_8() | PEEP_10() | PEEP_18()),
    ]
