...
class TestCriterion:
    ...
    def insert_expression(
        ...
        pi_pair = PopulationInterventionPairExpr(
            population_expr=logic.NoDataPreservingAnd(population),
        ...
        pi_pair = Recommendation.filter_intervention_criteria_by_population(pi_pair)
        ...
        p_combination_node = logic.NoDataPreservingOr(
            *graph.sink_nodes(CohortCategory.POPULATION)
        )
