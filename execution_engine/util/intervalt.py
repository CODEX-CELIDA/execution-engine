...
class IntervalTypeProtocol(Protocol):
    ...
    @classmethod
    def union_priority(cls) -> List[Enum]:
        """
    ...
    @classmethod
    def intersection_priority(cls) -> List[Enum]:
        """
...
class IntervalType(StrEnum, IntervalTypeProtocol):
    """
    ...
    @classmethod
    def union_priority(cls) -> list[Enum]:  # OR |
        """
    ...
    @classmethod
    def intersection_priority(cls) -> list[Enum]:  # AND &
        """
...
class IntInterval(AbstractDiscreteIntervalWithType[int, IntervalType]):
    """
    An integer interval.
    """
...
class DateTimeInterval(
    AbstractDiscreteIntervalWithType[datetime.datetime, IntervalType]
):
    """
